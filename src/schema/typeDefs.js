...
type Mutation {
    ...
    createLocation(name: String!, address: String!, latitude:String!, longitude: String!, id: ID!): Response!
    createEvent(name: String!, dateAndTime: String!, description: String!, id: ID!): Response!
